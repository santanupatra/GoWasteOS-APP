                ...
                <SafeAreaView style={[style.wrapper, {  backgroundColor: 'transparent' }]}>
                    ...
                    <View style={[style.hnavigation, style.mT3]}>
                        ...
                        <View style={style.hwrap}>
                            <Text style={style.navh}>Track Route</Text>
                                    ...
                                    <View style={style.cardbody}>
                                        <View style={styles.inrbody}>
                                            <View style={style.mB2}>
                                                <Text style={styles.labelg}>Driver Location</Text>
                                                <View style={[style.rowSec, style.alignCenter]}>
                                                    <TouchableOpacity >
                                                        <Icon name="ios-location" color="#ccc" size={15} />
                                                    </TouchableOpacity>
                                                    <Text style={styles.smlabel}>124-A Rassel Street</Text>
                                                </View>
                                            </View>
